/*
  ==============================================================================
    ...
    Unified Plugin Editor Implementation
...
namespace PatternColors {
    ...
    inline juce::Colour getAccentedColor(SerpeAudioProcessorEditor::BackgroundColor bgColor) {
        switch (bgColor) {
            case SerpeAudioProcessorEditor::BackgroundColor::Blue:
...
//==============================================================================
SerpeAudioProcessorEditor::SerpeAudioProcessorEditor (SerpeAudioProcessor& p)
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    docsToggleButton.setEnabled(true);
#else
    docsToggleButton.onClick = [this]() { /* WebView disabled on this platform */ };
    docsToggleButton.setEnabled(false); // Visually disabled on iPad
#endif
    ...
    // Initialize WebView documentation (platform-specific)
#if SERPE_ENABLE_WEBVIEW
...
SerpeAudioProcessorEditor::~SerpeAudioProcessorEditor()
{
}

//==============================================================================
void SerpeAudioProcessorEditor::paint (juce::Graphics& g)
{
...
void SerpeAudioProcessorEditor::resized()
{
...
void SerpeAudioProcessorEditor::timerCallback()
{
    ...
    bool patternChanged = false; // Use existing hash comparison for now
...
//==============================================================================
void SerpeAudioProcessorEditor::drawPatternCircle(juce::Graphics& g, juce::Rectangle<int> bounds)
{
...
void SerpeAudioProcessorEditor::updatePatternDisplay()
{
    juce::String binary = audioProcessor.getCurrentPatternDisplay();
...
void SerpeAudioProcessorEditor::updateAnalysisDisplay()
{
...
void SerpeAudioProcessorEditor::updateStepSceneButton()
{
...
void SerpeAudioProcessorEditor::parseUPIPattern()
{
...
void SerpeAudioProcessorEditor::onParseButtonClicked()
{
    parseUPIPattern();
}


void SerpeAudioProcessorEditor::toggleDocumentation()
{
#if SERPE_ENABLE_WEBVIEW
    if (!docsBrowser) 
    {
...
void SerpeAudioProcessorEditor::closeDocumentation()
{
#if SERPE_ENABLE_WEBVIEW
...
void SerpeAudioProcessorEditor::createDocumentationHTML()
{
#if SERPE_ENABLE_WEBVIEW
    if (!docsBrowser) return;
    ...
    // Load HTML content by writing to a platform-appropriate temporary file
    #if SERPE_IS_IPAD
...
juce::Colour SerpeAudioProcessorEditor::getBackgroundColour() const
{
...
void SerpeAudioProcessorEditor::cycleBackgroundColor()
{
...
void SerpeAudioProcessorEditor::mouseDoubleClick(const juce::MouseEvent& event)
{
    // Double-click anywhere to cycle background colors
    cycleBackgroundColor();
}

void SerpeAudioProcessorEditor::mouseDown(const juce::MouseEvent& event)
{
...
void SerpeAudioProcessorEditor::mouseMove(const juce::MouseEvent& event)
{
...
void SerpeAudioProcessorEditor::mouseExit(const juce::MouseEvent& event)
{
...
int SerpeAudioProcessorEditor::getStepIndexFromCoordinates(int mouseX, int mouseY, juce::Rectangle<int> circleArea) const
{
    auto pattern = audioProcessor.getPatternEngine().getCurrentPattern();
    int numSteps = static_cast<int>(pattern.size());
...
bool SerpeAudioProcessorEditor::isCoordinateInCircleArea(int mouseX, int mouseY, juce::Rectangle<int> circleArea) const
{
    return getStepIndexFromCoordinates(mouseX, mouseY, circleArea) >= 0;
}

SerpeAudioProcessorEditor::ClickResult SerpeAudioProcessorEditor::getStepClickDetails(int mouseX, int mouseY, juce::Rectangle<int> circleArea) const
{
    ClickResult result;
...
void SerpeAudioProcessorEditor::toggleHistory()
{
    // Close other views first (mutual exclusion)
    if (showingDocs) {
        showingDocs = false;
...
void SerpeAudioProcessorEditor::closeHistory()
{
    showingHistory = false;
    historyToggleButton.setButtonText("History");
    upiHistoryList.setVisible(false);
...
void SerpeAudioProcessorEditor::onHistoryItemClicked(int index)
{
...
void SerpeAudioProcessorEditor::onPresetItemClicked(int index)
{
...
void SerpeAudioProcessorEditor::togglePresets()
{
    // Close other views first (mutual exclusion)
    if (showingDocs) {
        showingDocs = false;
...
void SerpeAudioProcessorEditor::closePresets()
{
    showingPresets = false;
    presetToggleButton.setButtonText("Presets");
    presetBrowserList.setVisible(false);
...
void SerpeAudioProcessorEditor::showSavePresetDialog()
{
    #if JUCE_IOS
...
void SerpeAudioProcessorEditor::showSavePresetInlineInput()
{
...
void SerpeAudioProcessorEditor::saveCurrentPreset(const juce::String& name)
{
    auto& presetManager = audioProcessor.getPresetManager();
...
void SerpeAudioProcessorEditor::deleteSelectedPreset()
{
