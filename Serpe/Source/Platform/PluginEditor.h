...
{
public:
    UPIHistoryListModel(class SerpeAudioProcessorEditor& editor) : editorRef(editor) {}
...
private:
    class SerpeAudioProcessorEditor& editorRef;
};
...
{
public:
    PresetBrowserListModel(class SerpeAudioProcessorEditor& editor) : editorRef(editor) {}
...
//==============================================================================
/**
 * Unified Plugin Editor for Serpe
 * 
 * Supports all plugin formats with platform-specific adaptations:
 * - macOS Desktop: Full WebView documentation, unrestricted file access
 * - iPad iOS: Native documentation alternative, sandboxed file access
 * 
 * Core Features:
 ...
 */
class SerpeAudioProcessorEditor  : public juce::AudioProcessorEditor,
                                   public juce::Timer
{
public:
    SerpeAudioProcessorEditor (SerpeAudioProcessor&);
    ~SerpeAudioProcessorEditor() override;
    ...
    SerpeAudioProcessor& getAudioProcessor() { return audioProcessor; }
...
private:
    //==============================================================================
    SerpeAudioProcessor& audioProcessor;
    
    // UI Components (Legacy controls for compatibility)
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SerpeAudioProcessorEditor)
};